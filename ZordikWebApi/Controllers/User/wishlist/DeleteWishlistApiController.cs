...
namespace ZordikWebApi.Controllers.User.wishlist
{
    ...
    public class DeleteWishlistApiController : ControllerBase
    {
        ...
        [HttpPost]
        public CommonResponse<WishlistToCartResponse> MoveWishlistToCart([FromBody] WishlistToCartRequest Request)
        {
            return _deleteWishlist.MoveWishlistToCart(Request);
        }
    }
}
