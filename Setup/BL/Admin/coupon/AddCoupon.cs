...
{
    public class AddCoupon : IAddCoupon
    {
        private readonly IConfiguration _configuration;
        private readonly IWebHostEnvironment _environment;
        private readonly DataAccessClass dataAccess;

        public AddCoupon(IConfiguration config, IWebHostEnvironment environment)
        {
        ...
        public CommonResponse<AddCouponResponse> InsertCoupon(AddCouponRequest request)
        {
            CommonResponse<AddCouponResponse> response = new CommonResponse<AddCouponResponse>();
            ...
            try
            {
                ...
                dataAccess.ExecuteQuery(CommandType.StoredProcedure, "InsertCoupon", ds, TableName, parameters);
