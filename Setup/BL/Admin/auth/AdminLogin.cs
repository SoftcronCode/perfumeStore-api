...
namespace Setup.BL.Admin.auth
{
    public class AdminLogin : IAdminLogin
    {
        ...
        public CommonResponse<AdminLoginResponse> AdminSignIn(AdminLoginRequest objRequest)
        {
            CommonResponse<AdminLoginResponse> response = new CommonResponse<AdminLoginResponse>();
            ...
            try
            {
                ...
                dataAccess.ExecuteQuery(CommandType.StoredProcedure, "AdminLogin", ds, TableName, parameters);
