...
{
    public class SizeUpdate : ISizeUpdate
    {
        ...
        public SizeUpdate(IConfiguration config, IWebHostEnvironment environment)
        {
        ...
        {
            CommonResponse<SizeUpdateResponse> response = new();
            ...
            try
            {
                ...
                dataAccess.ExecuteQuery(CommandType.StoredProcedure, "UpdateSize", ds, TableName, parameters);
