...
namespace Setup.BL.Admin.product.size
{
    public class GetSize : IGetSize
    {
        ...
        public GetSize(IConfiguration configuration)
        {
            _configuration = configuration;
            _dataAccessClass = new DataAccessClass(_configuration);
        }

        public CommonResponse<GetSizeResponse> FetchSize(GetSizeRequest request)
        {
            CommonResponse<GetSizeResponse> response = new CommonResponse<GetSizeResponse>();
            ...
            try
            {
                ...
                _dataAccessClass.ExecuteQuery(CommandType.StoredProcedure, "FetchSizeForAdmin", ds, TableName, parameters);
