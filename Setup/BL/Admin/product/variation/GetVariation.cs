...
{
    public class GetVariation : IGetVariation
    {
        private readonly IConfiguration _configuration;
        private readonly DataAccessClass _dataAccessClass;

        public GetVariation(IConfiguration configuration)
        {
            _configuration = configuration;
            _dataAccessClass = new DataAccessClass(_configuration);
        }

        public CommonResponse<GetVariationResponse> FetchVariation(GetVariationRequest objRequest)
        {
            CommonResponse<GetVariationResponse> response = new CommonResponse<GetVariationResponse>();
            ...
            try
            {
                ...
                _dataAccessClass.ExecuteQuery(CommandType.StoredProcedure, "FetchVariationForAdmin", ds, TableName, parameters);
